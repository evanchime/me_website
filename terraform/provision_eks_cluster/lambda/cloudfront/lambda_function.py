...
def test_secret(service_client, arn, token):
    """
    Comprehensive validation that the new secret works across the entire stack:
    1. CloudFront Distribution is reachable and using the new header.
    2. ALB routes the request correctly.
    3. Application (Django) responds with a healthy status.
    """
